                         ...
                         bool include_validity)
{
  ...
  std::transform(cuda::make_counting_iterator(static_cast<size_t>(0)),
                 cuda::make_counting_iterator(expected_fixed.size()),
  ...
  split_custom_column<TypeParam>(
    ...
    [](cudf::table_view const& expected, cudf::table_view const& result) {
      std::for_each(cuda::make_counting_iterator(0),
                    cuda::make_counting_iterator(expected.num_columns()),
...
{
  std::vector<cudf::size_type> splits(cuda::make_counting_iterator(0),
cuda::make_counting_iterator(10000));
...
TEST_F(ContiguousSplitTableCornerCases, PreSplitTableLarge)
{
  ...
  auto el_iter                = cuda::make_counting_iterator(post_split_start);
