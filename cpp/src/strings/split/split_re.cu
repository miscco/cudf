                                ...
                                rmm::device_async_resource_ref mr)
{
  ...
  auto const columns_count = thrust::transform_reduce(
    ...
    cuda::make_counting_iterator<size_type>(strings_count),
  ...
  std::transform(cuda::make_counting_iterator<size_type>(0),
                 cuda::make_counting_iterator<size_type>(columns_count),
                 results.begin(),
                 make_strings_lambda);
