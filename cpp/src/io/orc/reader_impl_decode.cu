  ...
  rmm::cuda_stream_view stream)
{
  ...
  thrust::for_each(rmm::exec_policy_nosync(stream),
                   ...
                   cuda::make_counting_iterator(inflate_res.size()),
    ...
    if (chunks[0][col_idx].parent_validity_info.valid_map_base != nullptr) {
      ...
      if (child_valid_map_base != nullptr) {
        ...
        thrust::for_each(rmm::exec_policy_nosync(stream),
                         ...
                         cuda::make_counting_iterator(0) + dst_idx.size(),
                      ...
                      rmm::cuda_stream_view stream)
{
  ...
  thrust::for_each(rmm::exec_policy_nosync(stream),
                   ...
                   [num_stripes, chunks = chunks.device_view()] __device__(auto const& idx_psums) {
                     ...
                     thrust::transform(
                       thrust::seq,
                       cuda::make_counting_iterator<std::size_t>(0ul),
                       cuda::make_counting_iterator<std::size_t>(num_stripes),
                       psums,
                                     ...
                                     rmm::cuda_stream_view stream)
{
  ...
  thrust::transform(
    ...
    cuda::make_counting_iterator(0),
    cuda::make_counting_iterator(d_segmented_sizes->size()),
