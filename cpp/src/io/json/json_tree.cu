                                    ...
                                    rmm::device_async_resource_ref mr)
{
  ...
  {
    cudf::detail::copy_if(cuda::make_counting_iterator<NodeIndexT>(0),
                          cuda::make_counting_iterator<NodeIndexT>(0) + num_tokens,
                          tokens.begin(),
  ...
  auto const node_range_out_end = cudf::detail::copy_if(
    ...
    cuda::make_counting_iterator<size_type>(0) + num_tokens,
    node_range_out_it,
  ...
  if (is_strict_nested_boundaries) {
    ...
    auto zipped_in_it =
      thrust::make_zip_iterator(push_pop_it, cuda::make_counting_iterator<NodeIndexT>(0));
    ...
    thrust::transform(
      rmm::exec_policy_nosync(stream),
      cuda::make_counting_iterator<NodeIndexT>(0),
      cuda::make_counting_iterator<NodeIndexT>(0) + num_nested,
      parent_node_ids.begin(),
  ...
  rmm::cuda_stream_view stream)
{
  ...
  auto key_set                                  = cuco::static_set{cuco::extent{num_keys},
                                  ...
                                  stream.value()};
  auto const counting_iter                      = cuda::make_counting_iterator<size_type>(0);
  ...
  rmm::device_async_resource_ref mr)
{
  ...
  auto nodes_itr         = cuda::make_counting_iterator<size_type>(0);
                                                   ...
                                                   rmm::device_async_resource_ref mr)
{
  ...
  thrust::transform_if(
    rmm::exec_policy_nosync(stream),
    cuda::make_counting_iterator<size_type>(0),
    cuda::make_counting_iterator<size_type>(num_nodes),
    row_offsets.begin(),
    [node_categories = d_tree.node_categories.data(),
