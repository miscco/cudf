  ...
  rmm::cuda_stream_view stream)
{
  ...
  *current =
  ...
  std::transform(
    ...
    cuda::make_counting_iterator(scv.num_children()),
  ...
  rmm::device_async_resource_ref temp_mr)
{
  ...
  thrust::transform(
    ...
    cuda::make_counting_iterator<std::size_t>(num_bufs),
    d_dst_buf_info,
  ...
  rmm::device_async_resource_ref temp_mr)
{
  ...
  if (user_buffer_size != 0) {
    ...
    // apply changed offset
    {
      ...
      auto const iter     = cuda::make_counting_iterator(num_batches_in_first_iteration);
