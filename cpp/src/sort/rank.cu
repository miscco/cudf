                                                 ...
                                                 rmm::cuda_stream_view stream)
{
  ...
  auto const sorted_index_order = thrust::make_permutation_iterator(
    sorted_order_view.begin<size_type>(), cuda::make_counting_iterator<size_type>(0));
  ...
  auto const comparator_helper = [&](auto const device_comparator) {
    thrust::transform(rmm::exec_policy_nosync(stream),
                      ...
                      cuda::make_counting_iterator(input_size),
                ...
                rmm::cuda_stream_view stream)
{
  ...
  thrust::scatter(rmm::exec_policy_nosync(stream),
                  cuda::make_counting_iterator<size_type>(1),
                  cuda::make_counting_iterator<size_type>(rank_mutable_view.size() + 1),
                  sorted_order_view.begin<size_type>(),
